...
const PAST_EVENTS = [
  {
    ...
    highlight:
      "Nuestra primera Techno Night transformó un hotel campestre en un búnker industrial: visuales de club, energía intensa y un público que encendió la escena local.",
